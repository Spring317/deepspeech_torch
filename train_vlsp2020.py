#!/usr/bin/env python3
"""
Training script for Vietnamese ASR using vlsp2020_vinai_100h dataset from Hugging Face
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Train Vietnamese ASR with vlsp2020_vinai_100h dataset"
    )
    ...
    # Start training
    logger.info("="*50)
    logger.info("Starting training with vlsp2020_vinai_100h dataset")
    logger.info("="*50)
